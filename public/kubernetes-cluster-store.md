...
only stateful component of the [[kubernetes-control-plane|control plane]].
...
ensure this when multiple sources are attempting to modify the same value,
`etcd` makes use of the RAFT consensus algorithm.